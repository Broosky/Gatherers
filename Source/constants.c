...
void __cdecl CONSTANTS_Init(CONSTANTS_T* p_Constants) {
    ...
    snprintf(p_Constants->szDefaultSettingsFile, sizeof(p_Constants->szDefaultSettingsFile), "Configs/Gatherers.cfg");
    snprintf(p_Constants->szDefaultLogFile, sizeof(p_Constants->szDefaultLogFile), "Logs/Gatherers.log");
    snprintf(p_Constants->szDefaultSaveFile, sizeof(p_Constants->szDefaultSaveFile), "Sims/Gatherers.sav");
    p_Constants->fPi = 3.1416f;
    p_Constants->fDirtyZoneBuffer = 8.0f;
    p_Constants->sMessageLifespan = 35;
    p_Constants->uiTerrainTilesX = 4;
    p_Constants->uiTerrainTilesY = 4;
    p_Constants->MaxClientSize = (UIDELTA_T){ 1920, 1080 };
    p_Constants->MinClientSize = (UIDELTA_T){ 1024, 768 };
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
