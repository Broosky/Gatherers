...
LRESULT CALLBACK WINDOWS_PROCEDURE_WindowProc(HWND hWnd, UINT uiMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND: {
        WINDOWS_PROCEDURE_HandleMenuEvent(wParam, p_Menu, p_Globals, p_Globals->p_ActiveRenderer, p_Log, p_Settings, p_Constants);
        break;
    }
    case WM_SIZE: {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    case WM_LBUTTONDOWN: {
        ...
        if (PROCESS_IsMinimapClicked(p_Globals->p_ActiveRenderer, p_Assets, p_Globals, p_Settings)) {
            ...
            PROCESS_AdjustMinimapViewport(p_Globals, p_Globals->p_ActiveRenderer, p_Assets, p_Settings);
        }
        else {
            p_Globals->ubClickOriginFromMinimap = 0;
            WINDOWS_PROCEDURE_CreateOrCaptureEntities(p_Globals, p_Assets, p_Log, p_Globals->p_ActiveRenderer, p_Settings);
        }
        break;
    }
    case WM_RBUTTONDOWN: {
    ...
    case WM_KEYDOWN: {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        WINDOWS_PROCEDURE_HandleKeyDown(wParam, p_Globals, p_Menu, p_Globals->p_ActiveRenderer, p_Log, p_Settings);
        break;
    }
    case WM_CLOSE: {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_CreateOrCaptureEntities(GLOBALS_T* p_Globals, ASSETS_T* p_Assets, LOG_T* p_Log, RENDERER_T* p_Renderer, SETTINGS_T* p_Settings) {
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // For mouse drag selection.
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_HandleBorderless(GLOBALS_T* p_Globals, MENU_T* p_Menu, RENDERER_T* p_Renderer, SETTINGS_T* p_Settings, LOG_T* p_Log) {
    if (p_Menu->ubIsFullScreen) {
        ...
        if (p_Globals->ubIsBorderless) {
            WINDOWS_PROCEDURE_ExitBorderless(p_Globals, p_Renderer);
        }
        else {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_ExitBorderless(GLOBALS_T* p_Globals, RENDERER_T* p_Renderer) {
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_HandleFullscreen(GLOBALS_T* p_Globals, MENU_T* p_Menu, RENDERER_T* p_Renderer, SETTINGS_T* p_Settings, LOG_T* p_Log) {
    if (p_Menu->ubIsFullScreen) {
        WINDOWS_PROCEDURE_ExitFullscreen(p_Globals, p_Menu, p_Renderer, p_Settings, p_Log);
    }
    else {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_HandleKeyDown(WPARAM wParam, GLOBALS_T* p_Globals, MENU_T* p_Menu, RENDERER_T* p_Renderer, LOG_T* p_Log, SETTINGS_T* p_Settings) {
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Arrow keys.
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    WINDOWS_PROCEDURE_HandleArrowKeys(wParam, p_Globals, p_Menu, p_Renderer, p_Settings, p_Log);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Chord keys.
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (WINDOWS_PROCEDURE_HandleChordKeys(wParam, MOD_CONTROL, 'F')) {
        WINDOWS_PROCEDURE_HandleFullscreen(p_Globals, p_Menu, p_Renderer, p_Settings, p_Log);
    }
        ...
        SETTINGS_PropagateHotReload(p_Settings, p_Log, p_Constants->szDefaultSettingsFile, p_Globals);
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Other keys.
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    WINDOWS_PROCEDURE_HandleOtherKeys(wParam, p_Globals, p_Menu, p_Renderer, p_Settings, p_Log);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_HandleArrowKeys(WPARAM wParam, GLOBALS_T* p_Globals, MENU_T* p_Menu, RENDERER_T* p_Renderer, SETTINGS_T* p_Settings, LOG_T* p_Log) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_HandleOtherKeys(WPARAM wParam, GLOBALS_T* p_Globals, MENU_T* p_Menu, RENDERER_T* p_Renderer, SETTINGS_T* p_Settings, LOG_T* p_Log) {
    switch (wParam) {
    case VK_ESCAPE: {
        if (p_Globals->ubCreate) {
            WINDOWS_PROCEDURE_BuildNone(p_Globals, p_Menu);
            ...
            WINDOWS_PROCEDURE_HandleBorderless(p_Globals, p_Menu, p_Renderer, p_Settings, p_Log);
        }
        break;
    }
    case VK_DELETE: {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WINDOWS_PROCEDURE_HandleMenuEvent(WPARAM wParam, MENU_T* p_Menu, GLOBALS_T* p_Globals, RENDERER_T* p_Renderer, LOG_T* p_Log, SETTINGS_T* p_Settings, CONSTANTS_T* p_Constants) {
