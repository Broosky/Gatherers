    ...
    *iRollingAllocationHeap = sizeof(AI_CLOSEST) * (iResizeThresholdCapacity + 1);
    ...
    while(p_Current) {
        if((*p_Current).iType == iType && (*p_Current).bIsAlive) {
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            p_ClosestEntities[iCurrentAllocationCount].p_Entity = p_Current;
            p_ClosestEntities[iCurrentAllocationCount].fDistance = fDistance;
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            iCurrentAllocationCount++;
        }
        p_Current = (ENTITY*)(*p_Current).p_Next;
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Sort ascending.
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    qsort(p_ClosestEntities, iCurrentAllocationCount, sizeof(AI_CLOSEST), AI_CompareDistances);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
