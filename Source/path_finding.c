...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Updates the position of the entity by amplifying its unit vector by the movement speed.
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl PATH_UpdatePosition(RENDERER_T* p_Renderer, ENTITY_T* p_Entity, GLOBALS_T* p_Globals, MENU_T* p_Menu, SETTINGS_T* p_Settings, CONSTANTS_T* p_Constants, LOG_T* p_Log) {
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Minor vectors: we are close enough to the destination point, so let's snap to it.
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if (PATH_IsSufficientlyCloseMinorVector(p_Entity, p_Settings)) {
		PATH_SnapToPoint(p_Entity, p_Entity->MinorDestinationCenterPoint);
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Major vector: we are close enough to the destination point, so let's snap to it.
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if (PATH_IsSufficientlyCloseMajorVector(p_Entity, p_Settings)) {
			PATH_SnapToPoint(p_Entity, p_Entity->MajorDestinationCenterPoint);
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl PATH_SnapToPoint(ENTITY_T* p_Entity, FPOINT_T DestinationCenterPoint) {
	p_Entity->CenterPoint = DestinationCenterPoint;
	p_Entity->Location.fX = DestinationCenterPoint.fX - p_Entity->HalfSize.fDx;
	p_Entity->Location.fY = DestinationCenterPoint.fY - p_Entity->HalfSize.fDy;
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
