...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl ENGINE_ProcessScene(DOUBLE_BUFFER_T* p_DoubleBuffer, GLOBALS_T* p_Globals, ASSETS_T* p_Assets, CARD_T* p_Card, MENU_T* p_Menu, LOG_T* p_Log) {
    TIMEBASE_T* p_Timer = TIMEBASE_Create(0.0f, p_Globals, p_Log);
    if (p_Timer) {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        PROCESS_ProcessEntities(p_DoubleBuffer, p_Globals, p_Assets, p_Menu, p_Log);
        PROCESS_DrawSelectionArea(p_DoubleBuffer, p_Globals, p_Assets);
