...
void __cdecl PROCESS_PrepareFrame(RENDERER_T* p_Renderer, GLOBALS_T* p_Globals, ASSETS_T* p_Assets) {
	...
	FDELTA_T CropDelta = {
		-CropDestination.fX + ClientArea.right,
		-CropDestination.fY + ClientArea.bottom,
	};
	FPOINT_T CropSource = {
		0.0f,
		0.0f
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	p_Renderer->CropDrawPictureAt(p_Renderer, &p_Assets->Terrain[p_Globals->usMapIndex], CropDestination, CropDelta, CropSource, 0);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void __cdecl PROCESS_HandlePreProcessing(RENDERER_T* p_Renderer, MENU_T* p_Menu, ASSETS_T* p_Assets, GLOBALS_T* p_Globals, LOG_T* p_Log) {
	...
	if (p_Renderer->ubIsFullFrameRender) {
		PROCESS_PrepareFrame(p_Renderer, p_Globals, p_Assets);
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
