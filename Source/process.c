...
void __cdecl PROC_CaptureAndApplyTranslations(DBLBUF* p_DblBuf, GLOBALS* p_Globals, IMAGES* p_Images, MENU* p_Menu) {
    if((*p_Menu).ubEnableTranslations) {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        float fAmount = TRANSLATION_AMOUNT;
...
void __cdecl PROC_DrawBackground(DBLBUF* p_DblBuf, GLOBALS* p_Globals, IMAGES* p_Images) {
    DBLBUF_DrawPicture(p_DblBuf, &(*p_Images).Terrain[(*p_Globals).usMapIndex], 0);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    while(p_Current) {
        ...
        if(
            ...
            if((*p_Menu).ubDrawResources) {
                ...
                sprintf((*p_DblBuf).szBlitter, "%d", (*p_Current).iMineralCount);
                DBLBUF_Blitter(
                    p_DblBuf,
                    (*p_DblBuf).szBlitter,
                ...
                sprintf((*p_DblBuf).szBlitter, "%d", (*p_Current).iGasCount);
                DBLBUF_Blitter(
                    p_DblBuf,
                    (*p_DblBuf).szBlitter,
                    (FPOINT){(*p_Current).Location.fX, (*p_Current).Location.fY - 40.0f},
                    (*p_Menu).ubEnableMasking
                );
            }
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            if((*p_Menu).ubDrawIds) {
                ...
                sprintf((*p_DblBuf).szBlitter, "%d", (*p_Current).usId);
                DBLBUF_Blitter(
                    p_DblBuf,
                    (*p_DblBuf).szBlitter,
                    (FPOINT){(*p_Current).Location.fX, (*p_Current).Location.fY - 60.0f},
                    (*p_Menu).ubEnableMasking
                );
            }
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void __cdecl PROC_DrawDiagnostics(DBLBUF* p_DblBuf, GLOBALS* p_Globals, IMAGES* p_Images, MENU* p_Menu) {
    ...
    if((*p_Menu).ubDrawDiagnostics) {
        ...
        sprintf((*p_DblBuf).szBlitter, "(Tx, Ty): (%0.2f, %0.2f)", (*p_Globals).fLateralTranslation, (*p_Globals).fVerticalTranslation);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
        ...
        sprintf((*p_DblBuf).szBlitter, "(Mx, My): (%d, %d)", (*p_Globals).iMouseX, (*p_Globals).iMouseY);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        sprintf((*p_DblBuf).szBlitter, "(Sw, Sh): (%d, %d)", iCaptureWidth, iCaptureHeight);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "(Sx, Sy): (%d, %d) -> (%d, %d)", (*p_Globals).iCaptureStartX, (*p_Globals).iCaptureStartY, (*p_Globals).iCaptureCurrentX, (*p_Globals).iCaptureCurrentY);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "R/B: (%ld, %ld)", (*p_DblBuf).ClientArea.right, (*p_DblBuf).ClientArea.bottom);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "PTA: %0.2f ms/s", (*p_Globals).fProcessTimeAverage);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "PT: %0.2f ms", (*p_Globals).fProcessTime * 1000.0f);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "FPS: %0.2f", (*p_Globals).fFramesPerSecond);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "H: %d B", (*p_Globals).iRunningHeap);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "Ws: %d", ENTITY_GetSelectedEntityCounts(p_Globals).usSelectedWorkersCount);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "Es: %d", ENTITY_GetSelectedEntityCounts(p_Globals).usSelectedAllCount);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "Et: %d", (*p_Globals).usEntityCount);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        (*p_Globals).fClientBottomY -= 20.0f;
        sprintf((*p_DblBuf).szBlitter, "Mt: %d", (*p_Globals).usMessageCount);
        DBLBUF_Blitter(
            p_DblBuf,
            (*p_DblBuf).szBlitter,
            (FPOINT){15.0f, (*p_Globals).fClientBottomY},
