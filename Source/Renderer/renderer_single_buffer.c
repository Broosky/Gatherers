...
SINGLE_BUFFER_T* __cdecl SINGLE_BUFFER_Create(RENDERER_T* p_Renderer, GLOBALS_T* p_Globals, LOG_T* p_Log) {
    ...
    p_Renderer->DrawDirtyZones = SINGLE_BUFFER_DrawDirtyZones;
    p_Renderer->DrawTerrainGrid = SINGLE_BUFFER_DrawTerrainGrid;
    p_Renderer->DrawLine = SINGLE_BUFFER_DrawLine;
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl SINGLE_BUFFER_DrawTerrainGrid(RENDERER_T* p_Renderer, FPOINT_T From, FPOINT_T To, ASSETS_T* p_Assets, GLOBALS_T* p_Globals) {
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl SINGLE_BUFFER_DrawLine(RENDERER_T* p_Renderer, FPOINT_T From, FPOINT_T To, HPEN hPen) {
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl SINGLE_BUFFER_DrawMinimapEntities(RENDERER_T* p_Renderer, GLOBALS_T* p_Globals, FPOINT_T MinimapOrigin, ASSETS_T* p_Assets, SETTINGS_T* p_Settings, MENU_T* p_Menu, LOG_T* p_Log) {
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
