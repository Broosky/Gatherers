...
DOUBLE_BUFFER_T* __cdecl DOUBLE_BUFFER_Create(RENDERER_T* p_Renderer, GLOBALS_T* p_Globals, LOG_T* p_Log) {
    ...
    p_Renderer->DrawTerrainGrid = DOUBLE_BUFFER_DrawTerrainGrid;
    p_Renderer->DrawLine = DOUBLE_BUFFER_DrawLine;
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void __cdecl DOUBLE_BUFFER_FillDirtyZones(RENDERER_T* p_Renderer, ASSETS_T* p_Assets, GLOBALS_T* p_Globals, LOG_T* p_Log) {
    ...
    while (p_CurrentDirtyZone) {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Determine tiles based on frustum.
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl DOUBLE_BUFFER_DrawMinimapEntities(RENDERER_T* p_Renderer, GLOBALS_T* p_Globals, FPOINT_T MinimapOrigin, ASSETS_T* p_Assets, SETTINGS_T* p_Settings, MENU_T* p_Menu, LOG_T* p_Log) {
    DOUBLE_BUFFER_T* p_DoubleBuffer = DOUBLE_BUFFER_Cast(p_Renderer);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    HPEN hPen = NULL;
    HBRUSH hBrush = NULL;
    ...
    while (p_Current) {
        ...
        FPOINT_T EntityLocation = {
            (p_Current->CenterPoint.fX - p_Current->HalfSize.fDx - p_Globals->Translation.fDx) / p_Globals->TerrainCombinedSize.ulDx,
            (p_Current->CenterPoint.fY - p_Current->HalfSize.fDy - p_Globals->Translation.fDy) / p_Globals->TerrainCombinedSize.ulDy
        };
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (p_Current->ubIsSelected | p_Current->ubIsHighlighted) {
            ...
            case ENTITY_TYPE_WORKER:
                DOUBLE_BUFFER_DrawPictureAt(p_Renderer, &p_Assets->WorkerMini, RenderPoint, p_Menu->ubEnableMasking);
                break;
            case ENTITY_TYPE_COMMAND:
                DOUBLE_BUFFER_DrawPictureAt(p_Renderer, &p_Assets->CommandMini, RenderPoint, p_Menu->ubEnableMasking);
                break;
            case ENTITY_TYPE_MINERAL:
                DOUBLE_BUFFER_DrawPictureAt(p_Renderer, &p_Assets->MineralMini, RenderPoint, p_Menu->ubEnableMasking);
                break;
            case ENTITY_TYPE_SUPPLY:
                DOUBLE_BUFFER_DrawPictureAt(p_Renderer, &p_Assets->SupplyMini, RenderPoint, p_Menu->ubEnableMasking);
                break;
            case ENTITY_TYPE_REFINERY:
                DOUBLE_BUFFER_DrawPictureAt(p_Renderer, &p_Assets->RefineryMini, RenderPoint, p_Menu->ubEnableMasking);
                break;
            default: {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl DOUBLE_BUFFER_DrawTerrainGrid(RENDERER_T* p_Renderer, FPOINT_T From, FPOINT_T To, ASSETS_T* p_Assets, GLOBALS_T* p_Globals) {
    DOUBLE_BUFFER_T* p_DoubleBuffer = DOUBLE_BUFFER_Cast(p_Renderer);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    HGDIOBJ hPenTemp = SelectObject(p_DoubleBuffer->hDCMem, p_Assets->hPenTerrainGrid);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    MoveToEx(p_DoubleBuffer->hDCMem, From.fX, From.fY, NULL);
    LineTo(p_DoubleBuffer->hDCMem, To.fX, To.fY);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    SelectObject(p_DoubleBuffer->hDCMem, hPenTemp);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void __cdecl DOUBLE_BUFFER_DrawLine(RENDERER_T* p_Renderer, FPOINT_T From, FPOINT_T To, HPEN hPen) {
    DOUBLE_BUFFER_T* p_DoubleBuffer = DOUBLE_BUFFER_Cast(p_Renderer);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
