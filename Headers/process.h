...
// Prototypes:
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void    __cdecl     PROCESS_DrawSelectionArea               (DOUBLE_BUFFER_T*, GLOBALS_T*, COLORREF);
...
void    __cdecl     PROCESS_ProcessEntities                 (DOUBLE_BUFFER_T*, GLOBALS_T*, ASSETS_T*, MENU_T*);
...
void    __cdecl     PROCESS_DrawMinimapEntities             (DOUBLE_BUFFER_T*, GLOBALS_T*, FPOINT_T);
void    __cdecl     PROCESS_DrawMinimapViewport             (DOUBLE_BUFFER_T*, GLOBALS_T*, ASSETS_T*, FPOINT_T);
void    __cdecl     PROCESS_DrawMinimapSelectionArea        (DOUBLE_BUFFER_T*, GLOBALS_T*, FPOINT_T);
...
void    __cdecl     PROCESS_PopulateViewportRelativity      (FPOINT_T*, FPOINT_T*, FPOINT_T*, FPOINT_T*, DOUBLE_BUFFER_T*, ASSETS_T*, GLOBALS_T*);
void    __cdecl     PROCESS_PopulateMinimapDimensions       (FPOINT_T*, FPOINT_T*, DOUBLE_BUFFER_T*, ASSETS_T*);
