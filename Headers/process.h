...
FDELTA_T            __cdecl     PROCESS_ApplyTranslations                       (RENDERER_T*, GLOBALS_T*, ASSETS_T*);
...
void                __cdecl     PROCESS_DrawTaskbar                             (RENDERER_T*, GLOBALS_T*, ASSETS_T*, CARD_T*, MENU_T*);
void                __cdecl     PROCESS_HandleMinimap                           (RENDERER_T*, GLOBALS_T*, ASSETS_T*, SETTINGS_T*, LOG_T*);
void                __cdecl     PROCESS_DrawMinimapPicture                      (RENDERER_T*, GLOBALS_T*, ASSETS_T*, FPOINT_T);
void                __cdecl     PROCESS_DrawMinimapEntities                     (RENDERER_T*, GLOBALS_T*, FPOINT_T, ASSETS_T*, SETTINGS_T*, LOG_T*);
...
void                __cdecl     PROCESS_HandleHud                               (RENDERER_T*, GLOBALS_T*, ASSETS_T*, CARD_T*, MENU_T*, SETTINGS_T*, LOG_T*);
...
void                __cdecl     PROCESS_PopulateViewportRelativity              (FPOINT_T*, FDELTA_T*, FPOINT_T*, FDELTA_T*, RENDERER_T*, ASSETS_T*, GLOBALS_T*, SETTINGS_T*);
...
void                __cdecl     PROCESS_AdjustMinimapViewport                   (GLOBALS_T*, RENDERER_T*, ASSETS_T*, SETTINGS_T*);
...
void                __cdecl     PROCESS_DrawEngineAverage                       (FPOINT_T*, RENDERER_T*, UINT8, GLOBALS_T*, float);
...
void                __cdecl     PROCESS_DrawTranslationThreshold                (RENDERER_T*, ASSETS_T*, GLOBALS_T*);
