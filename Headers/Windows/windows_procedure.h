...
void                __cdecl     WINDOWS_PROCEDURE_HandleKeyDown                 (WPARAM, GLOBALS_T*, MENU_T*, RENDERER_T*, LOG_T*, SETTINGS_T*, CONSTANTS_T*, ASSETS_T*);
UINT8               __cdecl     WINDOWS_PROCEDURE_HandleChordKeys               (WPARAM, USHORT, WPARAM);
void                __cdecl     WINDOWS_PROCEDURE_HandleArrowKeys               (WPARAM, ASSETS_T*, GLOBALS_T*, MENU_T*, RENDERER_T*, SETTINGS_T*, LOG_T*);
void                __cdecl     WINDOWS_PROCEDURE_HandleOtherKeys               (WPARAM, GLOBALS_T*, MENU_T*, RENDERER_T*, SETTINGS_T*, ASSETS_T*, LOG_T*);
void                __cdecl     WINDOWS_PROCEDURE_HandleMenuEvent               (WPARAM, MENU_T*, GLOBALS_T*, RENDERER_T*, LOG_T*, SETTINGS_T*, ASSETS_T*, CONSTANTS_T*);
void                __cdecl     WINDOWS_PROCEDURE_HandleFullscreen              (GLOBALS_T*, MENU_T*, RENDERER_T*, SETTINGS_T*, ASSETS_T*, LOG_T*);
void                __cdecl     WINDOWS_PROCEDURE_HandleBorderless              (GLOBALS_T*, MENU_T*, RENDERER_T*, SETTINGS_T*, ASSETS_T*, LOG_T*);        
...
void                __cdecl     WINDOWS_PROCEDURE_ExitBorderless                (GLOBALS_T*, MENU_T*, RENDERER_T*);
